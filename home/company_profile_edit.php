<!DOCTYPE html>
<html lang="en">
<title>KaajKormo - Company-info-edit</title>

<head>
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="stylesheet" href="css/company_profile_edit_style.css">
...
<div class="company-info">
    <div class="display-info">
        ...
        <div class="basic-info">
            ...
            <p>Timespan : </p>
            <input type="text" name="timespan" id="timespan" placeholder="timespan">
            <p>Company Type : </p>
            <input type="text" name="company-type" id="company-type" placeholder="company-type">
            <!-- <p>Rank : 1</p> -->
            <!-- <p>Company : <a href="#"> Google </a></p> -->
            <p>HeadQaurtars : </p>
            <input type="text" name="headquartars" id="headquartars" placeholder="headquartars">
            <!-- <P>Rating : 5 star</P> -->
        </div>
    </div>
</div>
<div class="detailed-info">
    ...
    <div class="company-details">
        <h3>Company_Detail:</h3>
        <input type="text" class="details" name="details" id="details" placeholder="Write something about your company">
    </div>
</div>
<br>
<br>
